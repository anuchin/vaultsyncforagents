/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bbc7905001268ca0513565a9acc1b973)
// Runtime types generated with workerd@1.20260815.1 2026-08-01 
interface __BaseEnv_Env {
	BUCKET: R2Bucket;
	ASSETS: Fetcher;
	ROOM: DurableObjectNamespace<import("./src/index").VaultRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VaultRoom";
	}
